...
# 加载模型
model = keras.models.load_model("C:\\Users\DELL\Desktop\XAI code\\New common COVID DenseNet121.h5")
...
# "choose" 文件夹路径
choose_folder_path = "C:\\Users\DELL\Desktop\code\dataset\choose\COVID2"
# 初始化列表
original_images = []
heatmap_images = []
image_sizes = []
